# challenge 10 : http://www.pythonchallenge.com/pc/return/bull.html look-and-say sequence 8/2/17

import matplotlib.pyplot as plt

data = [146, 399, 163, 403, 170, 393, 169, 391, 166, 386, 170, 381, 170, 371, 170, 355, 169, 346, 167, 335, 170, 329,
...
def foo(test):
    ...
    for i in range(len(test) - 1):
        if test[i] == test[i + 1]:
            ...
            out = out + str(count) + test[i]
            count = 1
    out = out + str(count) + test[-1]
    return out
